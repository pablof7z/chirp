...
//! ([`nmp_native_runtime::dispatch_action_bytes_typed`], ADR-0064). Shells (TUI, desktop,
...
/// ([`nmp_native_runtime::dispatch_action_bytes_typed`], via the shared
...
impl ChirpClient {
    ...
    /// # Safety
    ///
    /// `app` must be a valid, non-null pointer to an [`NmpApp`].
    ...
    /// [`nmp_native_runtime::dispatch_action_bytes_typed`]. The JSON never crosses the
